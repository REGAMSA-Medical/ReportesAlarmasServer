...
# ORDER_STAGES = [
#     'Under Review', 'To Do', 'Production', 'Testing', 'Shipping', 'Delivery'
# ]
...
class Order(BaselineModel):
    ...
    stage = Column(Integer, ForeignKey('stages.id'), nullable=False, default=1)
    status = Column(Enum(OrderStatus), nullable=False, default=OrderStatus.NOT_STARTED
                    )
